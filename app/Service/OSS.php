...
class OSS {
    ...
    private $AccessKeyId = 'LTAIMymUUqEBpuQ7';
    private $AccessKeySecret = 'zCpocHI2U8RltxF6vYcYjhVwTark9s';
    ...
    public static function getUrl($bucketName, $key, $expire_time)
    {
        $oss = new OSS();
        $oss->ossClient->setBucket($bucketName);
        return $oss->ossClient->getUrl($key, $expire_time);
    }
}
